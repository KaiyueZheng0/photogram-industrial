...
ActiveRecord::Schema[8.0].define(version: 2025_04_09_200502) do
  ...
  create_table "follow_requests", force: :cascade do |t|
    ...
    t.index ["sender_id", "recipient_id"], name: "index_follow_requests_on_sender_id_and_recipient_id", unique: true
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["fan_id", "photo_id"], name: "index_likes_on_fan_id_and_photo_id", unique: true
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_photos_on_created_at", order: :desc
